...
{
    public partial class Instalmentrule
    {
        public Instalmentrule()
        {
            Institemsinstalmentrules = new HashSet<Institemsinstalmentrule>();
        }
        ...
        public virtual ICollection<Institemsinstalmentrule> Institemsinstalmentrules { get; set; }
    }
}

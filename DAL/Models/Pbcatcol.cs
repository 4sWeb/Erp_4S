...
namespace DAL.Models
{
    public partial class Pbcatcol
    {
        ...
        public decimal? PbcTid { get; set; }
        public string PbcOwnr { get; set; }
        public string PbcCnam { get; set; }
        public decimal? PbcCid { get; set; }
        public string PbcLabl { get; set; }
        public decimal? PbcLpos { get; set; }
        public string PbcHdr { get; set; }
        public decimal? PbcHpos { get; set; }
        public decimal? PbcJtfy { get; set; }
        public string PbcMask { get; set; }
        public decimal? PbcCase { get; set; }
        public decimal? PbcHght { get; set; }
        public decimal? PbcWdth { get; set; }
